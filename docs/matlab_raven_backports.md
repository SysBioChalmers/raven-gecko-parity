# MATLAB RAVEN and raven-toolbox: what each one lacks

> Moved here from raven-toolbox's own documentation tree. It is a parity record,
> which is what this repository is for: what MATLAB RAVEN still needs from
> raven-toolbox, and what raven-toolbox deliberately does not have.
...
* **MetaCyc-based reconstruction** (`external/metacyc/*`, `getMetaCycModelForOrganism`).
  ...
  [IMPROVEMENTS.md § R-MetaCyc](https://github.com/SysBioChalmers/raven-toolbox/blob/develop/IMPROVEMENTS.md).
